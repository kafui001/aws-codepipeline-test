...
#         # Subscribe all stage and prod approval emails
#         # all_approval_emails = set(stage_approval_emails + prod_approval_emails) 
...
#         # EventBridge rule to send SNS notifications on manual approval needed
...
class MultiBranchPipelineStack(Stack):
    def __init__(
        ...
        **kwargs
        ...
        # Grant cross-account usage for Stage
        for account in [stage_env.account]:
            artifact_key.add_to_resource_policy(
                iam.PolicyStatement(
                    actions=[
        ...
        # Grant cross-account bucket access for Stage
        for account in [stage_env.account]:
            artifact_bucket.add_to_resource_policy(
                iam.PolicyStatement(
                    actions=[
